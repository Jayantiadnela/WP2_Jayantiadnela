...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.0&nocache=6309463208ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.0" media="print" id="printcss">
    <title>localhost / 127.0.0.1 / pustaka | phpMyAdmin 5.1.0</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=id&amp;v=5.1.0"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/database/structure.js?v=5.1.0"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/table/change.js?v=5.1.0"></script>
...
function extendingValidatorMessages () {
  $.extend($.validator.messages, {
    ...
    validationFunctionForFuns: $.validator.format('Galat')
  });
}

CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"id",server:"1",table:"",db:"pustaka",token:"2c5944537e27692844292763372c4729",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Jelajahi",pma_text_left_default_tab:"Struktur",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.0",auth_type:"config",user:"root"});
...
<body>
    ...
    <div id="pma_navigation_content">
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          ...
          <a href="./doc/html/index.html" title="Dokumentasi phpMyAdmin" target="_blank" rel="noopener"><img src="themes/dot.gif" title="Dokumentasi phpMyAdmin" alt="Dokumentasi phpMyAdmin" class="icon ic_b_docs"></a>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=pustaka&amp;table=buku">`pustaka`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=pustaka&amp;table=kategori">`pustaka`.`kategori`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=pustaka&amp;table=user">`pustaka`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&amp;db=pustaka&amp;table=role">`pustaka`.`role`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&amp;server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&amp;server=1' title='Baru'>Baru</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Struktur'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Struktur'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Struktur'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Struktur'>phpmyadmin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cHVzdGFrYQ==" data-vpath="cm9vdA==.cHVzdGFrYQ==" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=pustaka&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=pustaka' title='Struktur'>pustaka</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGVzdA==" data-vpath="cm9vdA==.dGVzdA==" data-pos="0""></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=test&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=test' title='Struktur'>test</a><div class="clearfloat"></div></li>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php?route=%2Fdatabase%2Fstructure&db=pustaka&server=1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="2c5944537e27692844292763372c4729">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/">
        ...
        <a href="index.php?route=/database/structure&amp;db=pustaka">
          Database:          pustaka
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&amp;db=pustaka">
              <img src="themes/dot.gif" title="Struktur" alt="Struktur" class="icon ic_b_props">&nbsp;Struktur
                              <span class="sr-only">(sekarang)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&amp;db=pustaka">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&amp;db=pustaka">
              <img src="themes/dot.gif" title="Cari" alt="Cari" class="icon ic_b_search">&nbsp;Cari
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&amp;db=pustaka">
              <img src="themes/dot.gif" title="Kueri" alt="Kueri" class="icon ic_s_db">&nbsp;Kueri
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&amp;db=pustaka">
              <img src="themes/dot.gif" title="Ekspor" alt="Ekspor" class="icon ic_b_export">&nbsp;Ekspor
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&amp;db=pustaka">
              <img src="themes/dot.gif" title="Impor" alt="Impor" class="icon ic_b_import">&nbsp;Impor
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&amp;db=pustaka">
              <img src="themes/dot.gif" title="Operasi" alt="Operasi" class="icon ic_b_tblops">&nbsp;Operasi
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&amp;db=pustaka&amp;checkprivsdb=pustaka&amp;viewing_mode=db">
              <img src="themes/dot.gif" title="Hak Akses" alt="Hak Akses" class="icon ic_s_rights">&nbsp;Hak Akses
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&amp;db=pustaka">
              <img src="themes/dot.gif" title="Routine" alt="Routine" class="icon ic_b_routines">&nbsp;Routine
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&amp;db=pustaka">
              <img src="themes/dot.gif" title="Event" alt="Event" class="icon ic_b_events">&nbsp;Event
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&amp;db=pustaka">
              <img src="themes/dot.gif" title="Trigger" alt="Trigger" class="icon ic_b_triggers">&nbsp;Trigger
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&amp;db=pustaka">
              <img src="themes/dot.gif" title="Pelacakan" alt="Pelacakan" class="icon ic_eye">&nbsp;Pelacakan
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&amp;db=pustaka">
              <img src="themes/dot.gif" title="Desainer" alt="Desainer" class="icon ic_b_relations">&nbsp;Desainer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&amp;db=pustaka">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pustaka" targettable="kategori">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `kategori` (`id_kategori`, `nama_kategori`) VALUES (&#039;1&#039;, &#039;komputer&#039;), (&#039;2&#039;, &#039;bahasa&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="kategori">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `kategori` (`id_kategori`, `nama_kategori`) VALUES (&#039;3&#039;, &#039;sains&#039;), (&#039;4&#039;, &#039;hobby&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="kategori">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `kategori` (`id_kategori`, `nama_kategori`) VALUES (&#039;5&#039;, &#039;komunikasi&#039;), (&#039;6&#039;, &#039;hukum&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="kategori">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `kategori` (`id_kategori`, `nama_kategori`) VALUES (&#039;7&#039;, &#039;agama&#039;), (&#039;8&#039;, &#039;populer&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="kategori">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `kategori` (`id_kategori`, `nama_kategori`) VALUES (&#039;9&#039;, &#039;komik&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `buku`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="pustaka" targettable="role">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;1&#039;, &#039;Statistika dengan Program Komputer&#039;, &#039;1&#039;, &#039;Ahmad Kholiqul Amin&#039;, &#039;Deep Publish&#039;, &#039;2014&#039;, &#039;9786022809432&#039;, &#039;6&#039;, &#039;1&#039;, &#039;1&#039;, &#039;img1557402455.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;2&#039;, &#039;Mudah Belajar Komputer untuk Anak&#039;, &#039;1&#039;, &#039;Bambang Agus Setiawan&#039;, &#039;Huta Media&#039;, &#039;2014&#039;, &#039;9786025118500&#039;, &#039;5&#039;, &#039;3&#039;, &#039;1&#039;, &#039;img1557402397.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;5&#039;, &#039;PHP Komplet&#039;, &#039;1&#039;, &#039;Jubile e&#039;, &#039;Elex Media Komputindo&#039;, &#039;2017&#039;, &#039;8346753547&#039;, &#039;5&#039;, &#039;1&#039;, &#039;1&#039;, &#039;img1555522493.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;10&#039;, &#039;Detektif Conan Ep 200&#039;, &#039;9&#039;, &#039;Okigawa sasuke&#039;, &#039;Cultura&#039;, &#039;2016&#039;, &#039;874387583987&#039;, &#039;5&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557401465.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;14&#039;, &#039;Bahasa Indonesia&#039;, &#039;2&#039;, &#039;Umri Nur\&#039;aini dan Indriyani&#039;, &#039;Pusat Perbukuan&#039;, &#039;2015&#039;, &#039;75725472884&#039;, &#039;3&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557402703.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;15&#039;, &#039;Komunikasi Lintas Budaya&#039;, &#039;5&#039;, &#039;Dr. Dedy Kurnia&#039;, &#039;Published&#039;, &#039;2015&#039;, &#039;878674646488&#039;, &#039;5&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557403156.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;16&#039;, &#039;Kolaborasi Codeigniter dan Ajax dalam Perancangan&#039;, &#039;1&#039;, &#039;Anton Subagia&#039;, &#039;Elex Media Komputindo&#039;, &#039;2017&#039;, &#039;43345356577&#039;, &#039;5&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557403502.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;17&#039;, &#039;From Hobby to Money &#039;, &#039;4&#039;, &#039;Deasylawati&#039;, &#039;Elex Media Komputindo&#039;, &#039;2015&#039;, &#039;87968686787879&#039;, &#039;5&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557403658.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;18&#039;, &#039;Buku Saku Pramuka&#039;, &#039;8&#039;, &#039;Rudi Himawan&#039;, &#039;Pusat Perbukuan&#039;, &#039;2016&#039;, &#039;97868687978796&#039;, &#039;6&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557404613.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="pustaka" targettable="buku">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `dibooking`, `image`) VALUES (&#039;19&#039;, &#039;Rahasia Keajaiban Bumi&#039;, &#039;3&#039;, &#039;Nurul Ihsan&#039;, &#039;Luxima&#039;, &#039;2014&#039;, &#039;565756565768868&#039;, &#039;5&#039;, &#039;0&#039;, &#039;0&#039;, &#039;img1557404689.jpg&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="pustaka" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php?route=%2Fdatabase%2Fstructure&db=pustaka&server=1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="2c5944537e27692844292763372c4729">
  <input type="hidden" name="submit_save" value="DbStructure">
<ul class="tabs responsivetable row">
      <li><a href="#DbStructure">Stuktur basis data</a></li>
  </ul>
<div class="tabs_contents col">
<fieldset class="optbox" id="DbStructure">
<legend>Stuktur basis data</legend>
    <p>Pilih detail mana untuk menampilkan struktur database (daftar tabel).</p>
<table class="pma-table" width="100%" cellspacing="0">
<tr><th><label for="ShowDbStructureCharset">Tampilkan tabel set karakter</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureCharset" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help"></a>
</span><small>Show or hide a column displaying the charset for all tables.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureCharset" id="ShowDbStructureCharset"></span><a class="restore-default hide" href="#ShowDbStructureCharset" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureComment">Tampilkan komentar tabel</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureComment" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help"></a>
</span><small>Menampilkan atau menyembunyikan sebuah kolom yang menampilkan komentar untuk semua tabel.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureComment" id="ShowDbStructureComment"></span><a class="restore-default hide" href="#ShowDbStructureComment" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureCreation">Tampilkan timestamp pembuatan</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureCreation" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help"></a>
</span><small>Menampilkan atau menyembunyikan sebuah kolom yang menampilkan timestamp pembuatan untuk semua tabel.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureCreation" id="ShowDbStructureCreation"></span><a class="restore-default hide" href="#ShowDbStructureCreation" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureLastUpdate">Show last update timestamp</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureLastUpdate" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help"></a>
</span><small>Menampilkan atau menyembunyikan kolom yang menampilkan timestamp Terakhir diperbaharui untuk semua tabel.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureLastUpdate" id="ShowDbStructureLastUpdate"></span><a class="restore-default hide" href="#ShowDbStructureLastUpdate" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr><tr><th><label for="ShowDbStructureLastCheck">Tampilkan cek timestamp terakhir</label><span class="doc"><a href="./doc/html/config.html#cfg_ShowDbStructureLastCheck" target="documentation"><img src="themes/dot.gif" title="Dokumentasi" alt="Dokumentasi" class="icon ic_b_help"></a>
</span><small>Menampilkan atau menyembunyikan kolom yang menampilkan cek timestamp terakhir untuk semua tabel.</small></th><td><span class="checkbox"><input type="checkbox" name="ShowDbStructureLastCheck" id="ShowDbStructureLastCheck"></span><a class="restore-default hide" href="#ShowDbStructureLastCheck" title="Kembalikan nilai bawaan"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
</div>
</form>
<script type="text/javascript">
	...
	<div class="col-12">
		<fieldset id="tableFilter">
		    ...
		    <div class="formelement">
		        <label for="filterText">Mengandung kata:</label>
...
<input type="hidden" name="db" value="pustaka"><input type="hidden" name="token" value="2c5944537e27692844292763372c4729">
<div class="table-responsive">
<table class="table table-light table-striped table-hover table-sm w-auto">
    <thead class="thead-light">
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=table&amp;sort_order=DESC" title="Urutan" onmouseover="$('.sort_arrow').toggle();" onmouseout="$('.sort_arrow').toggle();">Tabel <img src="themes/dot.gif" title="" alt="Menaik" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Menurun" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Tindakan            </th>
                        <th>
                <a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=records&amp;sort_order=DESC" title="Urutan">Baris</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=type&amp;sort_order=ASC" title="Urutan">Jenis</a></th>
                <th><a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=collation&amp;sort_order=ASC" title="Urutan">Penyortiran</a></th>
            
                                            <th><a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=size&amp;sort_order=DESC" title="Urutan">Ukuran</a></th>
                                <th><a href="index.php?route=/database/structure&amp;db=pustaka&amp;pos=0&amp;sort=overhead&amp;sort_order=DESC" title="Urutan">Beban</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="BUKU">
    ...
    <th>
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=buku&amp;pos=0" title="">
            buku
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="aedb9209893c940f64f83632f2bc373b_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&amp;db=pustaka&amp;ajax_request=1&amp;favorite_table=buku&amp;add_favorite=1"
    title="Tambahkan ke favorit"
    data-favtargets="ffc6a44114486cca8c410708f831d6d7">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=buku&amp;pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Jelajahi" alt="Jelajahi" class="icon ic_b_browse">&nbsp;Jelajahi</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=buku">
          <span class="nowrap"><img src="themes/dot.gif" title="Struktur" alt="Struktur" class="icon ic_b_props">&nbsp;Struktur</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&amp;db=pustaka&amp;table=buku">
          <span class="nowrap"><img src="themes/dot.gif" title="Cari" alt="Cari" class="icon ic_b_select">&nbsp;Cari</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&amp;db=pustaka&amp;table=buku"><span class="nowrap"><img src="themes/dot.gif" title="Tambahkan" alt="Tambahkan" class="icon ic_b_insrow">&nbsp;Tambahkan</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=pustaka&amp;table=buku&amp;sql_query=TRUNCATE+%60buku%60&amp;message_to_show=Tabel%2Bbuku%2Btelah%2Bdikosongkan.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Kosongkan" alt="Kosongkan" class="icon ic_b_empty">&nbsp;Kosongkan</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=pustaka&amp;table=buku&amp;reload=1&amp;purge=1&amp;sql_query=DROP+TABLE+%60buku%60&amp;message_to_show=Tabel+buku+telah+terhapus.">
                <span class="nowrap"><img src="themes/dot.gif" title="Hapus" alt="Hapus" class="icon ic_b_drop">&nbsp;Hapus</span>
            </a>
        </td>
            ...
            data-table="buku">
                    ...
                    <td class="nowrap">
                            ...
                            <td class="nowrap">
                    <dfn title="Swedia, tidak peka huruf kapital">latin1_swedish_ci</dfn>

                </td>
                    
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=buku#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="KATEGORI">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=kategori&amp;pos=0" title="">
            kategori
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="45b6725516cd2fe83ca434986576de18_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&amp;db=pustaka&amp;ajax_request=1&amp;favorite_table=kategori&amp;add_favorite=1"
    title="Tambahkan ke favorit"
    data-favtargets="5f2de97ca0784918bd20b8d78a56a4ae">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=kategori&amp;pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Jelajahi" alt="Jelajahi" class="icon ic_b_browse">&nbsp;Jelajahi</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=kategori">
          <span class="nowrap"><img src="themes/dot.gif" title="Struktur" alt="Struktur" class="icon ic_b_props">&nbsp;Struktur</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&amp;db=pustaka&amp;table=kategori">
          <span class="nowrap"><img src="themes/dot.gif" title="Cari" alt="Cari" class="icon ic_b_select">&nbsp;Cari</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&amp;db=pustaka&amp;table=kategori"><span class="nowrap"><img src="themes/dot.gif" title="Tambahkan" alt="Tambahkan" class="icon ic_b_insrow">&nbsp;Tambahkan</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=pustaka&amp;table=kategori&amp;sql_query=TRUNCATE+%60kategori%60&amp;message_to_show=Tabel%2Bkategori%2Btelah%2Bdikosongkan.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Kosongkan" alt="Kosongkan" class="icon ic_b_empty">&nbsp;Kosongkan</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=pustaka&amp;table=kategori&amp;reload=1&amp;purge=1&amp;sql_query=DROP+TABLE+%60kategori%60&amp;message_to_show=Tabel+kategori+telah+terhapus.">
                <span class="nowrap"><img src="themes/dot.gif" title="Hapus" alt="Hapus" class="icon ic_b_drop">&nbsp;Hapus</span>
            </a>
        </td>
            ...
            data-table="kategori">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=kategori#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
            ...
            <tr id="row_tbl_3" data-filter-row="ROLE">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=role&amp;pos=0" title="">
            role
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="29a7e96467b69a9f5a93332e29e9b0de_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&amp;db=pustaka&amp;ajax_request=1&amp;favorite_table=role&amp;add_favorite=1"
    title="Tambahkan ke favorit"
    data-favtargets="a8415b437e3fd2403a46186a06e86218">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=role&amp;pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Jelajahi" alt="Jelajahi" class="icon ic_b_browse">&nbsp;Jelajahi</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=role">
          <span class="nowrap"><img src="themes/dot.gif" title="Struktur" alt="Struktur" class="icon ic_b_props">&nbsp;Struktur</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&amp;db=pustaka&amp;table=role">
          <span class="nowrap"><img src="themes/dot.gif" title="Cari" alt="Cari" class="icon ic_b_select">&nbsp;Cari</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&amp;db=pustaka&amp;table=role"><span class="nowrap"><img src="themes/dot.gif" title="Tambahkan" alt="Tambahkan" class="icon ic_b_insrow">&nbsp;Tambahkan</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=pustaka&amp;table=role&amp;sql_query=TRUNCATE+%60role%60&amp;message_to_show=Tabel%2Brole%2Btelah%2Bdikosongkan.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Kosongkan" alt="Kosongkan" class="icon ic_b_empty">&nbsp;Kosongkan</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=pustaka&amp;table=role&amp;reload=1&amp;purge=1&amp;sql_query=DROP+TABLE+%60role%60&amp;message_to_show=Tabel+role+telah+terhapus.">
                <span class="nowrap"><img src="themes/dot.gif" title="Hapus" alt="Hapus" class="icon ic_b_drop">&nbsp;Hapus</span>
            </a>
        </td>
            ...
            data-table="role">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=role#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
            ...
            <tr id="row_tbl_4" data-filter-row="USER">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=user&amp;pos=0" title="">
            user
        </a>
    ...
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&amp;db=pustaka&amp;ajax_request=1&amp;favorite_table=user&amp;add_favorite=1"
    title="Tambahkan ke favorit"
    data-favtargets="3c67f399163c56ef761e051e1835e19f">
    <span class="nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&amp;db=pustaka&amp;table=user&amp;pos=0">
          <span class="nowrap"><img src="themes/dot.gif" title="Jelajahi" alt="Jelajahi" class="icon ic_bd_browse">&nbsp;Jelajahi</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=user">
          <span class="nowrap"><img src="themes/dot.gif" title="Struktur" alt="Struktur" class="icon ic_b_props">&nbsp;Struktur</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&amp;db=pustaka&amp;table=user">
          <span class="nowrap"><img src="themes/dot.gif" title="Cari" alt="Cari" class="icon ic_bd_select">&nbsp;Cari</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&amp;db=pustaka&amp;table=user"><span class="nowrap"><img src="themes/dot.gif" title="Tambahkan" alt="Tambahkan" class="icon ic_b_insrow">&nbsp;Tambahkan</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=pustaka&amp;table=user&amp;sql_query=TRUNCATE+%60user%60&amp;message_to_show=Tabel%2Buser%2Btelah%2Bdikosongkan.">
                  <span class="nowrap"><img src="themes/dot.gif" title="Kosongkan" alt="Kosongkan" class="icon ic_bd_empty">&nbsp;Kosongkan</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=pustaka&amp;table=user&amp;reload=1&amp;purge=1&amp;sql_query=DROP+TABLE+%60user%60&amp;message_to_show=Tabel+user+telah+terhapus.">
                <span class="nowrap"><img src="themes/dot.gif" title="Hapus" alt="Hapus" class="icon ic_b_drop">&nbsp;Hapus</span>
            </a>
        </td>
            ...
            data-table="user">
                    ...
                    <td class="value tbl_size text-monospace text-right">
                <a href="index.php?route=/table/structure&amp;db=pustaka&amp;table=user#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KB</span>
                </a>
            </td>
            <td class="value tbl_overhead text-monospace text-right">
...
<tr>
    ...
    <th class="tbl_num text-nowrap">
                ...
                <th colspan="7" class="d-print-none">Jumlah</th>
                                                <th class="value tbl_rows text-monospace text-right">21</th>
        ...
        <th>
                            <dfn title="Swedia, tidak peka huruf kapital (Bawaan)">
                    latin1_swedish_ci
                </dfn>
                    </th>
    
                                    <th class="value tbl_size text-monospace text-right">64.0 KB</th>
  ...
  <p class="print_ignore">
    <a href="#" id="printView">
      <span class="nowrap"><img src="themes/dot.gif" title="Cetak" alt="Cetak" class="icon ic_b_print">&nbsp;Cetak</span>
    </a>
    <a href="index.php?route=/database/data-dictionary&amp;db=pustaka&amp;goto=index.php%3Froute%3D%2Fdatabase%2Fstructure" target="print_view">
      <span class="nowrap"><img src="themes/dot.gif" title="Kamus data" alt="Kamus data" class="icon ic_b_tblanalyse">&nbsp;Kamus data</span>
    </a>
  </p>
  ...
  <form id="create_table_form_minimal" method="post" action="index.php?route=/table/create" class="lock-page">
    <fieldset>
        <legend>
        <img src="themes/dot.gif" title="" alt="" class="icon ic_b_table_add">        Buat tabel        </legend>
        <input type="hidden" name="db" value="pustaka"><input type="hidden" name="token" value="2c5944537e27692844292763372c4729">
        <div class="formelement">
            Nama:
  ...
  <div id="selflink" class="print_ignore"><a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=pustaka&amp;server=1" title="Buka jendela phpMyAdmin baru" target="_blank" rel="noopener noreferrer"><img src="themes/dot.gif" title="Buka jendela phpMyAdmin baru" alt="Buka jendela phpMyAdmin baru" class="icon ic_window-new"></a></div>
